...
$mainMenuUserMobileOpen.on('click', function (e) {
	e.stopPropagation();
	if ($mainMenuUserMobileOpen.hasClass('-active')) {
		mainMenuUserMobileClose();
	} else {
		mainMenuUserMobileOpen();
	}
});

$mainMenuMobile.on('click', function (e) {
	e.stopPropagation();
});
...
var mainMenuMobileOpen = function mainMenuMobileOpen() {
